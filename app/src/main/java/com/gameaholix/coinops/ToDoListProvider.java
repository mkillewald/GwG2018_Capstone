...
public class ToDoListProvider implements RemoteViewsService.RemoteViewsFactory {
    ...
    ToDoListProvider(Context context, Intent intent) {
    ...
    public RemoteViews getViewAt(int position) {
        ...
        remoteView.setTextViewText(R.id.tv_heading, listItem.heading);
        remoteView.setTextViewText(R.id.tv_content, listItem.content);
